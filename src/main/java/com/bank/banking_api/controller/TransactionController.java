...
public class TransactionController {
    ...
    public ResponseEntity<TransactionResponseDTO> transferFunds(
        ...
        TransactionResponseDTO response = transactionService.transferFunds(request, authentication.getName());
    ...
    public ResponseEntity<List<TransactionResponseDTO>> getTransactionHistory(
        ...
        List<TransactionResponseDTO> response = transactionService.getTransactionHistory(accountNumber, authentication.getName());
        return new ResponseEntity<>(response, HttpStatus.OK);
    }
}